...
log_file = code_file[:-3]+'.log'
logging.basicConfig(filename=log_file,level= logging.DEBUG )
data_dir = '/home/triloq/Music/data/'
random_state = 9000
...
print_to_log = True
fname_1 = 'head_10_percent_feature_space_ntiled_500_oth_nbatr_hdfc_ib_def_3mon_train_20171130'
max_cols = 10
...
#PRE-REQUSITES
logging.debug(code_file+ ' at ' + runtime)
...
x_data = data.drop([id_col, y_label], axis = 1, inplace=False)
y_data = data[y_label]
split_ratio = 0.2
...
for clf in classifiers:
    fit_predict_score(clf = clf, display=True, save_file=infile_1+'_metrics', persist=True, description=str(clf))
